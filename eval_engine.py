...
def event_loop():
    ...
    while iteration <= rounds:
        ...
        t1 = threading.Thread(target=threaded_player_call, args=(0, None, iteration))
        t2 = threading.Thread(target=threaded_player_call, args=(1, None, iteration))
        t1.start(); t2.start()
